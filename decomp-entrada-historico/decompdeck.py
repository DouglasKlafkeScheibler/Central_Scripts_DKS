...
if __name__ == "__main__":
    ...
    #Lógica para upar 1 ano ou mais no banco. Cuidado com Itaipu e Mainthydro
    for y in range(1):
        year = str(y + 2018)
        ...
        for m in range(12):
            ...
            # pathdeck = '/Users/dougl/Desktop/Decomp-dataRaw/Decomp/2020/DC202001'

            #Procura pelos arquivos por essa lógica
                    ...
                    for name in directories:
                        ...
                        for f in files:
                            if 'DADGNL' in f:
                                ...
                                for block in args.toParse:
                                    ...
                                    if blocks[block].isParam:
                                        ...
                                        for info in result:
                                            ...
                                            table = 'dados_brutos.dec_in_' + info[0][:-4]
                                            columns = info[1]
                                            ...
                                            for row in data:
                                                temp = [x if x != '' else None for x in row]
                                                temp.append(refDate)
                                ...
                                paramTable = 'dados_brutos.dec_parameters'
                                for info in params:
